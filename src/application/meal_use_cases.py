...
class AnalyzeMealUseCase:
    ...
    def __init__(
        ...
        vision_adapter: LangChainAdapter,
    ):
        self.meal_repo = meal_repository
        self.profile_repo = profile_repository
        self.vision_adapter = vision_adapter

    def execute(self, profile_id: int, image_path: str, comment: str = "") -> Dict[str, Any]:
        try:
            ...
            analysis = self.vision_adapter.analyze_food_image(image_path, user_comment=comment)
            ...
            enriched_with = "openfoodfacts" if "openfoodfacts" in sources else "vision_estimate"
...
class GetTodaySummaryUseCase:
    ...
    def __init__(self, meal_repository: IMealRepository, profile_repository: IProfileRepository):
        self.meal_repo = meal_repository
        self.profile_repo = profile_repository
